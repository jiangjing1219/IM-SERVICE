...
public enum RouteHashMethodEnum {
     ...
     * TreeMap
     */
    TREE(1,"com.jiangjing.im.common.route.algorithm.consistenthash.TreeMapConsistentHash"),

    /**
     * 自定义map
     */
    CUSTOMER(2,"com.jiangjing.im.common.route.algorithm.consistenthash.xxxx"),
