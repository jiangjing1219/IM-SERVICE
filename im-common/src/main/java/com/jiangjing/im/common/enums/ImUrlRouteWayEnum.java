...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RAMDOM(1,"com.jiangjing.im.common.route.algorithm.random.RandomHandle"),


    /**
     * 1.轮训
     */
    LOOP(2,"com.jiangjing.im.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3,"com.jiangjing.im.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
